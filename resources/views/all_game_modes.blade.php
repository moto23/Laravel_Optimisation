                                            ...
                                            <table id="myTable" class="table-striped cell-border">
                                                ...
                                                <tbody>
                                                    @foreach ($modes as $mode)
                                                        <tr>
                                                            <td>{{ $mode['serial_no'] }}</td>
                                                            <td>{{ $mode['unique_id'] }}</td>
                                                            <td>
                                                                <a class="editbtn"
                                                                    data-mode-id="{{ $mode['mode_id'] }}">
                                                                    <i class="fas fa-solid fa-pen-to-square"
                                                                        style="color:#ff9d5c;margin-right:10px;cursor:pointer;"></i>
                                                                </a>
                                                            </td>
                                                            <td>{{ $mode['mode_name'] }}</td>
                                                            <td>{{ $mode['label_name'] }}</td>
                                                            <td>{{ $mode['champ_name'] }}</td>
                                                            <td>{{ $mode['gift_type'] }}</td>
                                                            <td>{{ $mode['gift_name'] }}</td>
                                                            <td>{{ $mode['no_of_question'] }}</td>
                                                            <td>{{ $mode['time_minutes'] }}</td>
                                                            <td>{{ $mode['user_qualification'] }}</td>
                                                            <td>{{ $mode['created_at_ist'] }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
