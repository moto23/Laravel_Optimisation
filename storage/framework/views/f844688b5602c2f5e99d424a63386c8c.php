                                    ...
                                    <div class="container">
                                        ...
                                        <div id="contact">
                                            ...
                                            <input
                                                ...
                                                value="<?php echo e(now()->timezone('Asia/Kolkata')->format('Y-m-d')); ?>"
                                                min="<?php echo e(date('Y-m-d')); ?>"><br>
                                            ...
                                            <input
                                                ...
                                                step="1" required
                                                value="<?php echo e(now()->timezone('Asia/Kolkata')->format('H:i:s')); ?>"><br>
...
<?php /**PATH C:\Users\prafu\Desktop\laravel-kgamify\resources\views/championship.blade.php ENDPATH**/ ?>