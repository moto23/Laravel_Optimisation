                                            ...
                                            <table id="myTable" class="table-striped cell-border">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($question['serial_no']); ?></td>
                                                            <td><?php echo e($question['unique_id']); ?></td>
                                                            <td>
                                                                <a class="editbtn"
                                                            ...
                                                            <td><?php echo e($question['label_name']); ?></td>
                                                            <td><?php echo $question['question_text']; ?></td>
                                                            <td><?php echo $question['option1_text']; ?></td>
                                                            <td><?php echo $question['option2_text']; ?></td>
                                                            <td><?php echo $question['option3_text']; ?></td>
                                                            <td><?php echo $question['option4_text']; ?></td>
                                                            <td><?php echo e($question['expected_time']); ?></td>
                                                            <td><?php echo e($question['total_coins']); ?></td>
                                                            <td><?php echo e($question['created_at_ist']); ?></td>
                                                        </tr>
...
<?php /**PATH C:\Users\prafu\Desktop\laravel-kgamify\resources\views/question_bank.blade.php ENDPATH**/ ?>